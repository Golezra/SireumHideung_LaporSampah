        ...
        <div class="container">
            ...
            <div class="header-content position-relative d-flex align-items-center justify-content-between">
                ...
                <div class="page-heading">
                    <h6 class="mb-0">Pembayaran Tunai</h6>
                </div>
        ...
        <div class="container">
            <div class="card invoice-card shadow">
                <div class="card-body">
                    ...
                    <form action="{{ route('pembayaran.tunai.proses', $laporan->id) }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-primary w-100 mt-3">Konfirmasi Bayar Tunai</button>
                    </form>
                </div>
            </div>
        </div>
